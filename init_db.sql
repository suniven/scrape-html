...
(
    ...
    `url`               varchar(1500)             NOT NULL COMMENT 'short url in comments',
    `url_hash`          varchar(32)               NOT NULL DEFAULT '' COMMENT 'md5(url)',
    `landing_page`      varchar(5000)             NOT NULL DEFAULT '' COMMENT 'first landing page of short url',
